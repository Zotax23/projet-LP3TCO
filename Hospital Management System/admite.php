...
<h3 style="font-family:calibri;" class="text-center">Informations Patient admis</h3></div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">clicker sur decharge pour liberer le patient.</h4>
<br />
<table style="background-color:#FFF; font-size:12px; " class="table table-striped table-hover table-bordered">
<thead>
<tr>
<th><strong>S.No</strong></th>
<th><strong>Admis .No</strong></th>
<th><strong>Patient .No</strong></th>
<th><strong>ADate</strong></th>
<th><strong>Patient Nom</strong></th>
<th><strong>Patient Age</strong></th>
<th><strong>Patient Contact</strong></th>
<th><strong>Patient Group sanguin</strong></th>
<th><strong>Patient maladie</strong></th>
<th><strong>Num chambre</strong></th>
</tr>
</thead>
<tbody>
<?php
...
<tr>
    ...
    <td align="center">Room No:<?php echo $row["admit_rn"]; ?></td>
      <td align="center"><a target="_blank" href="admiteinvo.php?id=<?php echo $row["admit_petid"];?> & rid=<?php echo $row["admit_rn"];?> & mid=<?php echo $row["pet_id"];?>">Decharger</a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
