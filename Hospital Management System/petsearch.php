...
<li id="lockkk" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadm.php"><strong>Informations sur les patients Modifier et supprimer</strong></a></li>
</ul>
</div></div>
...
<h3 style="font-family:calibri;" class="text-center">Recherche d’informations pour les patients</h3></div>
</div>
...
OPD Doctor Registration No : <?php echo $row["Pet_opdid"]?>| <a target="_blank" href="admitdf.php?id= <?php echo $row["Pet_opdid"]; ?>" name="ad"> Plus d’informations</a>
</h4>
...
<li style="background-color:rgba(255, 255, 255, 0.3);"><a style="colour:#000" target="_blank" href="admit.php?id=<?php echo $row["pet_id"]; ?>" name="ad">Admis à l’hôpital</a></li>
