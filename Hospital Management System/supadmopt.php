...
Vous êtes les bienvenus Top Level<?php echo $_SESSION['topadun']; ?> Options. <a href="dminlogout.php">Déconnexion</a>
</div>
<br>
<br><br />
<div class="container">
...
<h1 class="text-center ">Gestion de Patient<br /><small style="font-size:20px">Système de gestion hospitalière</small></h1>
</div>
</div>
</div>
<br /><br />
...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmopt.php"><strong>inserer super administration</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesupad.php"><strong>Supprimer Super administration</strong></a></li>
</ul>
<hr>
</div></div>
<?php
...
<div align="center" >
Vous êtes les bienvenus à l’enregistrement des utilisateurs du système à partir de.</div><br>
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">Ce formulaire d’inscription d’utilisateur crée des comptes Super administrateur.</div></div>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-offset-4 col-xs-12">
<div class="panel panel-default">
<div class="panel-heading text-center">Formulaire d’inscription à la super administration</div>
...
document.write('<?php echo $pwm; ?>');</script> </center> </td></tr>
  <tr><td colspan="2" style="padding:5px;"><center><button name="register" class="btn btn-block">ENVOYER</button></center></td></tr>
...
Copyright © 2023 Gestion de Patient
        </div>
    </div>
    </div>
  </footer>
