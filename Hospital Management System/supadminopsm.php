...
<h1 class="text-center ">lGestion de Patient<br /><small style="font-size:20px">Système de gestion hospitalière</small></h1></div>
<div class="container">
<div class="row">
<div class="col-md-12 col-xs-12 ">
<br></p>
...
<h4 style="font-family:calibri;" class="text-center alert alert-danger">Appuyez sur Boutton recherche pour voir tous les détails</h4>
</div>
</div>
</div>
<div class="container">
...
<footer>
	<hr />
    <center><h5 style="color:#FFF">Gestion de Patient@2023</h5><center>
</footer>
</html>
