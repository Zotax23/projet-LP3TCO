...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="invoinfo.php"><strong>consultation patient</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="invoadinfo.php"><strong>facture patent admis</strong></a></li>
...
<h3 class="panel-title text-center">Patient consultation</h3>
</div>
<center>
...
<tr>
  ...
  <tr>
  <td colspan="2" style="padding:5px"><div align="center"><button   name="submit" type="submit" class="btn" value="SUBMIT">ENVOYER</button></div></td>
    </tr>
