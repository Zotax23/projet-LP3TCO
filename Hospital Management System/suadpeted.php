...
<h3 style="font-family:calibri;" class="text-center">Mettre à jour les renseignements sur les patients</h3></div>
</div>
</div>
</div>
...
<div class="row">
<div class="">
<h4 style="font-family:calibri;" class="text-center">Activer les champs à l’aide de la liste déroulante des champs actifs</h4>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4">
<ul class="nav  nav-justified" style="background-color:#FFF;">
<li style="font-family:calibri; font-size:16px;"><a href="supadminop.php">Retour!</a></ul>
</div>
</div>
</div>
<br />
...
<form class="" action="" method="post" id="upform">
  ...
  <select name="gen"  id="gen"  style="margin:5px"    class="form-control" placeholder="Select your Gendere">
      ...
      <option value="Female">Femelle</option></dd>
  </select>
