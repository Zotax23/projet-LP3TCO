...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<br />
	<div align="center">
	<button name="login" onclick="chcke();"  type="submit" value="SUBMIT" class="btn ">ENVOYER</button>
	<br>
	<center><script type="text/javascript">
	document.write('<?php echo $fail; ?>');</script></center>
	<div align="center">
		<br>
		<p>Vous n’êtes pas encore inscrit? <a target="_blank" style="font-colour="Blue"" href='superadmin.php'>Inscrivez-vous ici</a></p>
	</div>
	...
	<br>Il s’agit du formulaire de connexion principal du système pour accéder au système. vous pouvez entrer les informations de connexion administrateur Super et Basic. si vous n’êtes pas membre de systeme, 
	créez votre accès de connexion en utilisant 
 <a target="_blank" style="font-colour="Blue"" href='superadmin.php'>Inscrivez-vous ici</a>
<br>
	<br>Entrez les informations de connexion fournies par Hospital Administartion. </div>
	</div>
  ...
  <p style="text-align: center;">Copyright © 2023 Gestion de Patient</p>
</div>
