...
<h1 class="text-center "><img width="9%" src="images/logol.png">Gestion Patient</h1>
<!-- <br /><small style="font-size:20px">Hospital Management System</small></h1></div> -->
...
<div class="row">
  ...
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffmemd.php"><strong>Consultation par le Patient</strong></a></li>
  ...
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffactmem.php"><strong>Listes des Consultations</strong></a></li>
...
<h3 style="font-family:calibri;" class="text-center">Listes des Consultations effectués par le Patient</h3></div>
</div>
</div>
</div>
...
<th><strong>Nom Complét</strong></th>
<th><strong>Staff Memeber Type</strong></th>
<th><strong>Contact Number</strong></th>
<th><strong>Group Sanguin</strong></th>
