...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadminop.php"><strong>Modifier les renseignements sur les patients</strong></a></li>
...
<h3 style="font-family:calibri;" class="text-center">Information Patient </h3></div>
</div>
</div>
</div>
<div class="container">
...
<h4 style="font-family:calibri;" class="text-center alert alert-danger">Appuyez sur le boutton recherche pour voir tous les détails</h4>
</div>
</div>
</div>
<div class="container">
<table style="background-color: rgba(222,444,444,0.0);" class="table table-responsive" width="500" border="0"><form action="" method="post">
  <tr>
    ...
    <td align="center"><button name="filter"  type="submit" class="btn  btn-default btn-block">Rechercher</button></td>
  </tr></form>
</table>
</div>
...
<dl>
  ...
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="suadpeted.php?id=<?php echo $row["pet_id"]; ?>" style="colour:#000">Mettre à jour</a></li>
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="deletepet.php?id=<?php echo $row["pet_id"]; ?>" style="colour:#000">Supprimer</a></li>
  </ul>
