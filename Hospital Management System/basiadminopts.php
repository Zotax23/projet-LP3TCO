...
Vous êtes les bienvenus <?php echo $_SESSION['topadun']; ?> Options. <a href="dminlogout.php">DECONNEXION</a>
</div><br />
<br /><br />
...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="basiadminopts.php"><strong>inserer Basic administration</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesbsad.php"><strong>suppression Basic administration</strong></a></li>
</ul>
<hr>
</div></div>

<div align="center" >
Vous êtes les bienvenus pour l’inscription des utilisateurs du système à partir de.</div><br>
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">Ce formulaire d’inscription d’utilisateur ne crée que des comptes de résition, seuls les comptes de resiption peuvent être insérés.</div></div>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-offset-4 col-xs-12">
<div class="panel panel-default">
<div class="panel-heading text-center">Formulaire d’inscription à l’administration système</div>
